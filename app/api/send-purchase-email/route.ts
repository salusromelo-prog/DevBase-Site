...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Seu DevBase Components está pronto</title>
</head>
<body style="margin:0;padding:0;background:#0a0a0a;font-family:'Segoe UI',Arial,sans-serif;color:#ffffff;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0a0a0a;padding:40px 0;">
    <tr>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
          ...
          <tr>
            <td style="background:#111111;border:1px solid #27272a;border-radius:12px;padding:40px 36px;">
              ...
              <!-- Título -->
              <h1 style="margin:0 0 12px;font-size:26px;font-weight:700;letter-spacing:-0.8px;text-align:center;color:#ffffff;">
                Seu DevBase Components está pronto!
              </h1>

              <!-- Subtítulo -->
              <p style="margin:0 0 32px;font-size:15px;color:#a1a1aa;text-align:center;line-height:1.6;">
                Obrigado pela compra do DevBase Components. Clique no botão abaixo para baixar seu kit.
              </p>
              ...
              <ol style="margin:0;padding:0 0 0 18px;color:#a1a1aa;font-size:13px;line-height:1.9;">
                <li>Clique em "Baixar Components" acima — o download começa automaticamente</li>
                <li>Copie a pasta kit-componentes-br para dentro do seu projeto Next.js</li>
                <li>Rode <code style="background:#1a1a1a;padding:1px 5px;border-radius:3px;font-size:12px;">npm install</code> para instalar as dependências do seu projeto</li>
                <li>Para usar o PixButton, instale também: <code style="background:#1a1a1a;padding:1px 5px;border-radius:3px;font-size:12px;">npm install qrcode.react</code></li>
                <li>Importe os componentes direto de kit-componentes-br — sem configuração extra</li>
              </ol>
...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Seu combo DevBase está pronto</title>
</head>
<body style="margin:0;padding:0;background:#0a0a0a;font-family:'Segoe UI',Arial,sans-serif;color:#ffffff;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0a0a0a;padding:40px 0;">
    <tr>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
          ...
          <tr>
            <td style="background:#111111;border:1px solid #27272a;border-radius:12px;padding:40px 36px;">
              ...
              <!-- Título -->
              <h1 style="margin:0 0 12px;font-size:26px;font-weight:700;letter-spacing:-0.8px;text-align:center;color:#ffffff;">
                Seu combo Boilerplate + Components está pronto!
              </h1>

              <!-- Subtítulo -->
              <p style="margin:0 0 32px;font-size:15px;color:#a1a1aa;text-align:center;line-height:1.6;">
                Obrigado pela compra do combo DevBase. Clique nos botões abaixo para baixar os dois produtos.
              </p>
              ...
              <ol style="margin:0;padding:0 0 0 18px;color:#a1a1aa;font-size:13px;line-height:1.9;">
                <li>Baixe os dois arquivos acima</li>
                <li>Extraia cada ZIP em sua respectiva pasta</li>
                <li>Copie o arquivo .env.example do Boilerplate para .env.local e preencha suas chaves</li>
                <li>Rode <code style="background:#1a1a1a;padding:1px 5px;border-radius:3px;font-size:12px;">npm install</code> e depois <code style="background:#1a1a1a;padding:1px 5px;border-radius:3px;font-size:12px;">npm run dev</code> no Boilerplate</li>
                <li>Copie a pasta kit-componentes-br para dentro do seu projeto Next.js</li>
                <li>Para usar o PixButton, instale também: <code style="background:#1a1a1a;padding:1px 5px;border-radius:3px;font-size:12px;">npm install qrcode.react</code></li>
                <li>Acesse http://localhost:3000 — seu SaaS está no ar com os componentes prontos</li>
              </ol>
...
export async function POST(request: NextRequest) {
  ...
  const htmlMap: Record<string, string> = {
    boilerplate: BOILERPLATE_HTML,
    'kit-componentes': KIT_HTML,
    combo: COMBO_HTML,
  }

  const html = htmlMap[produto]
  if (!html) {
    return Response.json({ error: 'produto não suportado' }, { status: 400 })
  }

  const subjects: Record<string, string> = {
    boilerplate: 'Seu DevBase Boilerplate está pronto 🚀',
    'kit-componentes': 'Seu DevBase Components está pronto 📦',
    combo: 'Seu combo DevBase está pronto 🚀📦',
  }
